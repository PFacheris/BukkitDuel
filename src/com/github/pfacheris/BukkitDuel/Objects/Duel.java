...
public class Duel {
	...
	public Duel(Player initiator, Player challengee, Arena arena)
	{
	...
	public void setInitiator(Player newDuelist)
	{
	...
	public void setChallengee(Player newDuelist)
	{
	...
	public void startDuel(BukkitDuel plugin)
	{
		this.isActive = true;
		...
		Listener listener = new PlayerInDuelListener(plugin,this);
